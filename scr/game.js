    ...
    gameLoop = () => {
        ...
        //* 2. Movement and changes on elements
            if (this.levelNumber == 1){
                this.virusArr.forEach((eachVirus) =>eachVirus.virusMove(2.5));
                this.spawnVirus();
            } else if (this.levelNumber == 2){
                this.virusArr.forEach((eachVirus) =>eachVirus.virusMove(4));
                this.spawnVirus();
            } else if (this.levelNumber == 3){
                this.virusArr.forEach((eachVirus) =>eachVirus.virusMove(4.5));
                this.spawnVirus();
            }
